...
def getArguments():
    parser = ArgumentParser(description='Calculates sequence length from the count of closed syncmers.\n',
    ...
    parser.add_argument("-n", "--number_of_submers", dest="number_of_submers", type=int, required=True,
                        help="NUMBER_OF_SUBMERS is the count of closed syncmers within a sequence.", metavar="NUMBER_OF_SUBMERS")
